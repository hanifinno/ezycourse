...
const Color PRIMARY_COLOR = Color(0xff023d45);
const Color PRIMARY_COLOR_3 = Color(0xff115c67);
const Color PRIMARY_COLOR_2 = Color(0xff307777);
...
const Color APP_BLUE = Color(0xff718EBF);
const Color TEXT_WHITE_1 = Color(0x80f5f5ff);
const Color YELLOW = Color(0xffE8F54A);
...
const Color GREY_COLOR = Color.fromARGB(255, 150, 148, 148);


const Color BUTTON_GRADIENT_FIRST_COLOR = Color(0xB700D7A3);
const Color BUTTON_GRADIENT_SECOND_COLOR =  Color(0x6E00B7CC);
