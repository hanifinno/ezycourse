...
// CommentReplyReactionModel commentReplyReactionModelFromJson(String str) =>
//     CommentReplyReactionModel.fromJson(json.decode(str));

// String commentReplyReactionModelToJson(CommentReplyReactionModel data) =>
...
//   factory CommentReplyReactionModel.fromJson(Map<String, dynamic> json) =>
//       CommentReplyReactionModel(
//         status: json['status'],
//         reactions: List<ReplyReactions>.from(
//             json['reactions'].map((x) => ReplyReactions.fromJson(x))),
//       );
